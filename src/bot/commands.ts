...
export const BOT_COMMANDS: { command: string; description: string }[] = [
  ...
  { command: "rich", description: "Rich text only for tables, tasks, details, math" },
...
export const HELP_TEXT = [
  ...
  "/rich \u2014 /rich on|off. On: ordinary replies stay Markdown; tables, task lists, <details>, and $$ math use rich text",
